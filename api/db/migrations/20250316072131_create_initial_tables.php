...
final class CreateInitialTables extends AbstractMigration
{
    ...
    {
        // Create admin table
        $admin = $this->table('admin', ['engine' => 'MyISAM', 'collation' => 'utf8_general_ci']);
        ...
        // Create page table
        $page = $this->table('page', ['engine' => 'MyISAM', 'collation' => 'utf8_general_ci']);
        ...
        // Create posts table
        $posts = $this->table('posts', ['engine' => 'MyISAM', 'collation' => 'utf8_general_ci']);
