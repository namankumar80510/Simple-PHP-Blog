...
<body>
    ...
    <header class="w3-container w3-teal">
        <h1>PHP Blog Admin</h1>
    </header>

    <div class="w3-bar w3-border">
        <a href="/" target="_blank" class="w3-bar-item w3-button w3-pale-green">View Site</a>
        <?php
    ...
    <div class="w3-container">
        <form action="<?= $url_path ?>search" method="GET" class="w3-container">
            <p>
